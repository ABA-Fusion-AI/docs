...
node_id: "postbin"
title: "PostBin"
description: "Create bins and post/receive HTTP requests for testing via PostBin"
category: "peer-only"
...
Create bins and post/receive HTTP requests for testing via PostBin
<!-- /SECTION: overview -->
...
title: Use PostBin in a workflow
```
<!-- /SECTION: examples -->
