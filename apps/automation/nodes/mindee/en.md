...
node_id: "mindee"
title: "Mindee"
description: "Parse documents (invoices, receipts, passports) using Mindee Document AI"
category: "peer-only"
...
Parse documents (invoices, receipts, passports) using Mindee Document AI
<!-- /SECTION: overview -->
...
title: Use Mindee in a workflow
```
<!-- /SECTION: examples -->
