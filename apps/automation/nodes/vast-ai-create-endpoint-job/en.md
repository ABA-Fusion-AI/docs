---
node_id: "vast-ai-create-endpoint-job"
title: "VastAI: Create Endpoint Job"
description: "Creates a new job processing endpoint with specified parameters."
category: "peer-only"
...
<!-- SECTION: overview -->
# VastAI: Create Endpoint Job

> **Category:** Peer-only Integrations&nbsp;&nbsp;|&nbsp;&nbsp;**Type:** Action Node

Creates a new job processing endpoint with specified parameters.
<!-- /SECTION: overview -->
...
title: Use VastAI: Create Endpoint Job in a workflow
```
<!-- /SECTION: examples -->
