...
node_id: "mailjet"
title: "Mailjet"
description: "Mailjet transactional email API. Send emails, manage contacts, campaigns, and statistics."
category: "peer-only"
...
Mailjet transactional email API. Send emails, manage contacts, campaigns, and statistics.
<!-- /SECTION: overview -->
...
title: Use Mailjet in a workflow
```
<!-- /SECTION: examples -->
