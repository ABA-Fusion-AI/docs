---
node_id: "venafi-tls-dc"
title: "Venafi TLS Datacenter"
description: "Manage certificates via Venafi TLS Protect Datacenter"
category: "peer-only"
...
<!-- SECTION: overview -->
# Venafi TLS Datacenter

> **Category:** Peer-only Integrations&nbsp;&nbsp;|&nbsp;&nbsp;**Type:** Action Node

Manage certificates via Venafi TLS Protect Datacenter
<!-- /SECTION: overview -->
...
title: Use Venafi TLS Datacenter in a workflow
```
<!-- /SECTION: examples -->
