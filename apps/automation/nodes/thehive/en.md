...
node_id: "thehive"
title: "TheHive"
description: "TheHive security incident response platform API. Manage cases, alerts, and observables."
category: "peer-only"
...
TheHive security incident response platform API. Manage cases, alerts, and observables.
<!-- /SECTION: overview -->
...
title: Use TheHive in a workflow
```
<!-- /SECTION: examples -->
