---
node_id: "vast-ai-prepay-instance"
title: "VastAI: Prepay Instance"
description: "Adds prepayment to the specified instance."
category: "peer-only"
...
Adds prepayment to the specified instance.
<!-- /SECTION: overview -->
...
title: Use VastAI: Prepay Instance in a workflow
```
<!-- /SECTION: examples -->
