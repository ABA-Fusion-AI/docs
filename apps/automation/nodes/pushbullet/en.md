...
node_id: "pushbullet"
title: "Pushbullet"
description: "Send notes, links, and files, and manage devices and contacts via Pushbullet."
category: "peer-only"
...
Send notes, links, and files, and manage devices and contacts via Pushbullet.
<!-- /SECTION: overview -->
...
title: Use Pushbullet in a workflow
```
<!-- /SECTION: examples -->
