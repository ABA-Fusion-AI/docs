---
node_id: "ms-sharepoint"
title: "Microsoft SharePoint"
description: "Manage SharePoint files and lists via Microsoft Graph API"
category: "peer-only"
...
Manage SharePoint files and lists via Microsoft Graph API
<!-- /SECTION: overview -->
...
title: Use Microsoft SharePoint in a workflow
```
<!-- /SECTION: examples -->
