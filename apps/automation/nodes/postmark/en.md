...
node_id: "postmark"
title: "Postmark"
description: "Send transactional emails, manage templates, and retrieve message details via the Postmark API."
category: "peer-only"
...
Send transactional emails, manage templates, and retrieve message details via the Postmark API.
<!-- /SECTION: overview -->
...
title: Use Postmark in a workflow
```
<!-- /SECTION: examples -->
