---
node_id: "securityscorecard-action"
title: "SecurityScorecard"
description: "Retrieve security ratings, portfolios, issues, and alerts via the SecurityScorecard API."
category: "peer-only"
...
Retrieve security ratings, portfolios, issues, and alerts via the SecurityScorecard API.
<!-- /SECTION: overview -->
...
title: Use SecurityScorecard in a workflow
```
<!-- /SECTION: examples -->
