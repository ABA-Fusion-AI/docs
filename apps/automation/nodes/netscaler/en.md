...
node_id: "netscaler"
title: "Netscaler ADC"
description: "Manage Citrix NetScaler ADC virtual servers, services, and service groups via the NITRO REST API."
category: "peer-only"
...
Manage Citrix NetScaler ADC virtual servers, services, and service groups via the NITRO REST API.
<!-- /SECTION: overview -->
...
title: Use Netscaler ADC in a workflow
```
<!-- /SECTION: examples -->
