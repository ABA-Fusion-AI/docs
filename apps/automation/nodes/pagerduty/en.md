...
node_id: "pagerduty"
title: "PagerDuty"
description: "Manage incidents, alerts, services, and on-call schedules in PagerDuty."
category: "peer-only"
...
Manage incidents, alerts, services, and on-call schedules in PagerDuty.
<!-- /SECTION: overview -->
...
title: Use PagerDuty in a workflow
```
<!-- /SECTION: examples -->
