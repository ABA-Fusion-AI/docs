...
node_id: "paypal"
title: "PayPal"
description: "Manage PayPal orders, invoices, payouts, and transactions via the PayPal REST API."
category: "peer-only"
...
Manage PayPal orders, invoices, payouts, and transactions via the PayPal REST API.
<!-- /SECTION: overview -->
...
title: Use PayPal in a workflow
```
<!-- /SECTION: examples -->
