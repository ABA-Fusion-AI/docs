...
node_id: "posthog"
title: "PostHog"
description: "Capture events, identify users and query analytics in PostHog"
category: "peer-only"
...
Capture events, identify users and query analytics in PostHog
<!-- /SECTION: overview -->
...
title: Use PostHog in a workflow
```
<!-- /SECTION: examples -->
