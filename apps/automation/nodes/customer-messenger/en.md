---
node_id: "customer-messenger"
title: "Customer Messenger (Training)"
description: "Training node: simulate customer messaging operations"
category: "peer-only"
...
<!-- SECTION: overview -->
# Customer Messenger (Training)

> **Category:** Peer-only Integrations&nbsp;&nbsp;|&nbsp;&nbsp;**Type:** Action Node

Training node: simulate customer messaging operations
<!-- /SECTION: overview -->
...
title: Use Customer Messenger (Training) in a workflow
```
<!-- /SECTION: examples -->
