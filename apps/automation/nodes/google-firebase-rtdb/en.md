---
node_id: "google-firebase-rtdb"
title: "Google Firebase Realtime DB"
description: "Read and write data to Firebase Realtime Database via REST API"
category: "peer-only"
...
Read and write data to Firebase Realtime Database via REST API
<!-- /SECTION: overview -->
...
title: Use Google Firebase Realtime DB in a workflow
```
<!-- /SECTION: examples -->
