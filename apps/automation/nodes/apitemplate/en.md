...
description: "Generate images and PDFs from templates using APITemplate.io"
category: "peer-only"
...
Generate images and PDFs from templates using APITemplate.io
<!-- /SECTION: overview -->
...
title: Use APITemplate.io in a workflow
```
<!-- /SECTION: examples -->
