---
node_id: "surveymonkey"
title: "SurveyMonkey"
description: "Manage SurveyMonkey surveys, collectors, responses, and questions via the SurveyMonkey API."
category: "peer-only"
...
Manage SurveyMonkey surveys, collectors, responses, and questions via the SurveyMonkey API.
<!-- /SECTION: overview -->
...
title: Use SurveyMonkey in a workflow
```
<!-- /SECTION: examples -->
