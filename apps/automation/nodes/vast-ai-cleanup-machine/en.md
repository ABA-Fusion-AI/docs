---
node_id: "vast-ai-cleanup-machine"
title: "VastAI: Cleanup Machine"
description: "Removes expired contracts on a specified machine, freeing up space."
category: "peer-only"
...
Removes expired contracts on a specified machine, freeing up space.
<!-- /SECTION: overview -->
...
title: Use VastAI: Cleanup Machine in a workflow
```
<!-- /SECTION: examples -->
