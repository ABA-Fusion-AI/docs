...
node_id: "currents"
title: "Currents"
description: "Interact with Currents.dev test analytics platform to manage runs, instances, and projects."
category: "peer-only"
...
Interact with Currents.dev test analytics platform to manage runs, instances, and projects.
<!-- /SECTION: overview -->
...
title: Use Currents in a workflow
```
<!-- /SECTION: examples -->
