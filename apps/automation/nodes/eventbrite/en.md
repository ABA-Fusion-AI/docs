...
node_id: "eventbrite"
title: "Eventbrite"
description: "Manage Eventbrite events, attendees, orders, organizations, and venues."
category: "peer-only"
...
Manage Eventbrite events, attendees, orders, organizations, and venues.
<!-- /SECTION: overview -->
...
title: Use Eventbrite in a workflow
```
<!-- /SECTION: examples -->
