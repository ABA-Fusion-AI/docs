---
node_id: "freshworks-crm"
title: "Freshworks CRM"
description: "Freshworks CRM API. Manage contacts, deals, and accounts."
category: "peer-only"
...
Freshworks CRM API. Manage contacts, deals, and accounts.
<!-- /SECTION: overview -->
...
title: Use Freshworks CRM in a workflow
```
<!-- /SECTION: examples -->
