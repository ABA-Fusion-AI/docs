...
node_id: "airtop"
title: "Airtop"
description: "Airtop browser automation API. Create sessions, navigate, and extract web content."
category: "peer-only"
...
Airtop browser automation API. Create sessions, navigate, and extract web content.
<!-- /SECTION: overview -->
...
title: Use Airtop in a workflow
```
<!-- /SECTION: examples -->
