...
node_id: "segment"
title: "Segment"
description: "Send analytics data to Segment (identify, track, page, group)"
category: "peer-only"
...
Send analytics data to Segment (identify, track, page, group)
<!-- /SECTION: overview -->
...
title: Use Segment in a workflow
```
<!-- /SECTION: examples -->
