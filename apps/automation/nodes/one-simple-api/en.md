---
node_id: "one-simple-api"
title: "One Simple API"
description: "Web utility API for social info, PDF generation, screenshots, and exchange rates."
category: "peer-only"
...
Web utility API for social info, PDF generation, screenshots, and exchange rates.
<!-- /SECTION: overview -->
...
title: Use One Simple API in a workflow
```
<!-- /SECTION: examples -->
