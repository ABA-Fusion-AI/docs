---
node_id: "customer-datastore"
title: "Customer Datastore (Training)"
description: "Training node: simulate CRUD operations on a customer datastore"
category: "peer-only"
...
Training node: simulate CRUD operations on a customer datastore
<!-- /SECTION: overview -->
...
title: Use Customer Datastore (Training) in a workflow
```
<!-- /SECTION: examples -->
