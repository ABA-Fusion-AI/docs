---
node_id: "vast-ai-request-logs"
title: "VastAI: Request Logs"
description: "Requests logs for the specified instance. Returns an S3 URL for log retrieval."
category: "peer-only"
...
Requests logs for the specified instance. Returns an S3 URL for log retrieval.
<!-- /SECTION: overview -->
...
title: Use VastAI: Request Logs in a workflow
```
<!-- /SECTION: examples -->
