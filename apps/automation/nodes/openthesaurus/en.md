---
node_id: "openthesaurus"
title: "OpenThesaurus"
description: "Look up synonyms, similar words, and thesaurus data using OpenThesaurus API"
category: "peer-only"
...
Look up synonyms, similar words, and thesaurus data using OpenThesaurus API
<!-- /SECTION: overview -->
...
title: Use OpenThesaurus in a workflow
```
<!-- /SECTION: examples -->
