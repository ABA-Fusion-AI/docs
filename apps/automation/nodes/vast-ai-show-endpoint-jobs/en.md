---
node_id: "vast-ai-show-endpoint-jobs"
title: "VastAI: Show Endpoint Jobs"
description: "Retrieves the list of endpoint jobs associated with the authenticated user."
category: "peer-only"
...
<!-- SECTION: overview -->
# VastAI: Show Endpoint Jobs

> **Category:** Peer-only Integrations&nbsp;&nbsp;|&nbsp;&nbsp;**Type:** Action Node

Retrieves the list of endpoint jobs associated with the authenticated user.
<!-- /SECTION: overview -->
...
title: Use VastAI: Show Endpoint Jobs in a workflow
```
<!-- /SECTION: examples -->
