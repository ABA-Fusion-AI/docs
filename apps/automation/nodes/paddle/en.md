...
node_id: "paddle"
title: "Paddle"
description: "Manage products, subscriptions, customers and transactions via Paddle billing."
category: "peer-only"
...
Manage products, subscriptions, customers and transactions via Paddle billing.
<!-- /SECTION: overview -->
...
title: Use Paddle in a workflow
```
<!-- /SECTION: examples -->
