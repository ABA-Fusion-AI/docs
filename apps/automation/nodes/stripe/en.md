...
node_id: "stripe"
title: "Stripe"
description: "Manage Stripe charges, customers, subscriptions, payment intents, and more."
category: "peer-only"
...
Manage Stripe charges, customers, subscriptions, payment intents, and more.
<!-- /SECTION: overview -->
...
title: Use Stripe in a workflow
```
<!-- /SECTION: examples -->
