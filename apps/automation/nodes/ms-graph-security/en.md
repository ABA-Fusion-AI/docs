---
node_id: "ms-graph-security"
title: "Microsoft Graph Security"
description: "Manage security alerts, incidents, secure scores, and vulnerabilities via Microsoft Graph Security API."
category: "peer-only"
...
Manage security alerts, incidents, secure scores, and vulnerabilities via Microsoft Graph Security API.
<!-- /SECTION: overview -->
...
title: Use Microsoft Graph Security in a workflow
```
<!-- /SECTION: examples -->
