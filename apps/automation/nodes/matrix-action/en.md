---
node_id: "matrix-action"
title: "Matrix Action"
description: "Perform actions on Matrix (send messages, manage rooms, invite users)"
category: "peer-only"
...
Perform actions on Matrix (send messages, manage rooms, invite users)
<!-- /SECTION: overview -->
...
title: Use Matrix Action in a workflow
```
<!-- /SECTION: examples -->
