...
node_id: "getresponse"
title: "GetResponse"
description: "Manage contacts, campaigns and newsletters in GetResponse"
category: "peer-only"
...
Manage contacts, campaigns and newsletters in GetResponse
<!-- /SECTION: overview -->
...
title: Use GetResponse in a workflow
```
<!-- /SECTION: examples -->
