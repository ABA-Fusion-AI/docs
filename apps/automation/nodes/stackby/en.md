...
node_id: "stackby"
title: "Stackby"
description: "Stackby spreadsheet database API. Manage tables, rows, and data."
category: "peer-only"
...
Stackby spreadsheet database API. Manage tables, rows, and data.
<!-- /SECTION: overview -->
...
title: Use Stackby in a workflow
```
<!-- /SECTION: examples -->
