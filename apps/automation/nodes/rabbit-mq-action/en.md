...
- **Async Processing:** Action completes → RabbitMQ Publish → [RabbitMQ Trigger](./rabbit-mq-trigger.md) → Worker workflow
...
- [RabbitMQ Trigger](./rabbit-mq-trigger.md) - Consume messages from a RabbitMQ queue
