...
This node is the **server-side push** counterpart to the [SignalR Trigger](./signal-r-receive.md) receiver. Use it to send events from your workflow into SignalR clients in real time.
...
- [SignalR Trigger](./signal-r-receive.md) - Receive real-time events from SignalR clients
- [Event Hub Send](./event-hub-send.md) - Send events to Azure Event Hubs for large-scale ingestion
