...
node_id: "thehive5"
title: "TheHive 5"
description: "TheHive 5 security incident response platform API. Manage cases, alerts, observables, and tasks."
category: "peer-only"
...
TheHive 5 security incident response platform API. Manage cases, alerts, observables, and tasks.
<!-- /SECTION: overview -->
...
title: Use TheHive 5 in a workflow
```
<!-- /SECTION: examples -->
