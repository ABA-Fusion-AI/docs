---
node_id: "vast-ai-execute-command"
title: "VastAI: Execute Command"
description: "Executes a command on the specified instance."
category: "peer-only"
...
<!-- SECTION: overview -->
# VastAI: Execute Command

> **Category:** Peer-only Integrations&nbsp;&nbsp;|&nbsp;&nbsp;**Type:** Action Node

Executes a command on the specified instance.
<!-- /SECTION: overview -->
...
title: Use VastAI: Execute Command in a workflow
```
<!-- /SECTION: examples -->
